    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.FileField(blank=True, null=True, upload_to='', verbose_name='Answer')),
                ('result', models.IntegerField(choices=[(100, 'Waiting'), (101, 'Running'), (102, 'Pretest Passed (Past)'), (130, 'Compile Error'), (131, 'Compile Finished'), (200, 'Locked'), (201, 'Pretest Passed'), (202, 'Running on Contest'), (400, 'Rejected'), (1000, 'Accepted'), (1001, 'Wrong Answer'), (1002, 'Time Limit Exceeded'), (1003, 'Memory Limit Exceeded'), (1004, 'Runtime Error')], default=100, verbose_name='Judge Result')),
